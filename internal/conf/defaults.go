...
func setDefaultConfig() {
	...
	*/
	...
	viper.SetDefault("notification.templates.infrequentspecies.message", "infrequent detection of {{.CommonName}} with {{.ConfidencePercent}}% confidence at {{.DetectionTime}}. Last seen : {{.DaysSinceLastSeen}}. View: {{.DetectionURL}} {{.ImageURL}}")
