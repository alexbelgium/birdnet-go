...
var goldenRoutes = []string{
	...
	"GET /api/v2/analytics/species/review-stats",
	"GET /api/v2/analytics/species/summary",
	"GET /api/v2/analytics/species/thumbnails",
	"GET /api/v2/analytics/species/tools",
	"GET /api/v2/analytics/species/tools/observation-link",
	"GET /api/v2/analytics/species/tools/recordings",
	...
	"GET /api/v2/detections/confirmed",
	"GET /api/v2/detections/ignored",
	"GET /api/v2/detections/included",
	...
	"POST /api/v2/detections/confirm",
	"POST /api/v2/detections/ignore",
	"POST /api/v2/detections/include",
	"POST /api/v2/detections/species/delete",
