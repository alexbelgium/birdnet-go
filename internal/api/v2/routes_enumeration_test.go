...
var goldenRoutes = []string{
	...
	"GET /api/v2/species",
	"GET /api/v2/species-workspace/best-recordings",
	"GET /api/v2/species-workspace/layout",
	"GET /api/v2/species-workspace/memberships",
	"GET /api/v2/species-workspace/recordings",
	"GET /api/v2/species-workspace/species",
	"GET /api/v2/species-workspace/species/stats",
	...
	"POST /api/v2/search",
	"POST /api/v2/species-workspace/species/delete",
	...
	"PUT /api/v2/settings",
	"PUT /api/v2/species-workspace/layout",
	"PUT /api/v2/species-workspace/memberships/:kind",
	...
	"echo_route_not_found /api/v2/settings/*",
	"echo_route_not_found /api/v2/species-workspace",
	"echo_route_not_found /api/v2/species-workspace/*",
