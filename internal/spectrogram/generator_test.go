...
// produces rate resampling to 240 kHz (0-120 kHz display range).
func TestGetSoxSpectrogramArgs_BatProfile(t *testing.T) {
	...
	// Bat profile: resample to 240 kHz for 0-120 kHz display range
	...
	assert.NotContains(t, args, "sinc", "bat profile should not use sinc filter")
}
